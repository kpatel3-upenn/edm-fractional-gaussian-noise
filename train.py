...
@click.option('--precond',       help='Preconditioning & loss function', metavar='vp|ve|edm|edm-fg',       type=click.Choice(['vp', 've', 'edm', 'edm-fg']), default='edm-fg', show_default=True)
...
def main(**kwargs):
    ...
    elif opts.precond == 'edm-fg':
        assert opts.precond == 'edm-fg'
        c.network_kwargs.class_name = 'training.networks.EDMPrecond'
        c.loss_kwargs.class_name = 'training.loss.EDMLoss_fractional_gaussian'
